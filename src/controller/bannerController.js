...
export async function getAllBanner(req, res) {
  try {
    ...
    return response.success(
      ...
      req.languageCode,
      resStatusCode.ACTION_COMPLETE,
      resMessage.BANNER_LIST_FETCHED,
      updatedBannerList
    );
  } catch (err) {
    console.error(err);
...
export async function inActiveBannerById(req, res) {
  ...
  try {
    ...
    return response.success(
      ...
      req.languageCode,
      resStatusCode.ACTION_COMPLETE,
      resMessage.BANNER_STATUS_UPDATED,
      updatedBanner
    );
  } catch (err) {
    console.error(err);
